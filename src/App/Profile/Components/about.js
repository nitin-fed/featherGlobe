    ...
    <div className="container main">
      <div>
        ...
        <div className="description">
          12+ year of extensive experience as a Front End Developer in
          developing web applications using various technologies including
          HTML5, CSS3, JavaScript, jQuery, Object Oriented JavaScript, Backbone
          JS, ReactJS, ReduxJS, JEST, Node JS, YUI, Kendo UI.
        </div>
        <br />
        <div className="leftAlign">
          <ul>
            ...
            <li>
              Building websites and apps that are responsive using re-usable
              components.
            </li>
            <li>
            ...
            <li>
              Communicating technical issues in an understandable manner to the
              team and clients.
            </li>
            <li>
            ...
            <li>
              Maintaining an organizing workflow using a project management tool
              (like GitHub).
            </li>
            <li>
            ...
            <li>
              <b>ADA</b> (Americans with Disabilities Act) - experience with ADA
